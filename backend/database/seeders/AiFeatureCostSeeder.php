...
class AiFeatureCostSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $costs = [
            ...
            ['feature_code' => 'nutrition_text_analysis', 'feature_name' => 'Registro de Refeição por Texto IA', 'credits_required' => 1],
            ['feature_code' => 'nutrition_photo_analysis', 'feature_name' => 'Análise de Foto de Refeição IA', 'credits_required' => 1],
            ['feature_code' => 'workout_import_photo', 'feature_name' => 'Importacao de Treino por Foto IA', 'credits_required' => 50],
            ['feature_code' => 'evolution_photo_comparison', 'feature_name' => 'Comparacao de Fotos de Evolucao IA', 'credits_required' => 60],
            ['feature_code' => 'evolution_session_analysis', 'feature_name' => 'Analise de Sessao de Fotos de Evolucao IA', 'credits_required' => 60],
            ['feature_code' => 'evolution_ai_report', 'feature_name' => 'Relatorio Inteligente de Evolucao', 'credits_required' => 80],
