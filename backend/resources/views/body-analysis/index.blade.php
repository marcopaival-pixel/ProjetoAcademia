        ...
        <aside class="cyber-metrics">
            ...
            <div class="card glass ai-insights" id="aiInsightsCard">
                ...
                <div id="analysisDetails" class="mt-3 d-none">
                    <div class="text-xs font-bold text-zinc-500 uppercase tracking-widest mb-2">Pontos de atencao</div>
        ...
        <div class="p-6 md:p-8 grid grid-cols-1 md:grid-cols-2 gap-8 bg-zinc-950/30">
            ...
            <div class="space-y-4">
                <div class="flex items-center gap-3 mb-4">
                    ...
                    <h4 class="text-lg font-bold text-white uppercase tracking-widest">Recuperacao e Habitos</h4>
                </div>
