...
@section('title', 'Redefinir senha - NexShape')
    ...
    <div class="w-full lg:w-1/2 flex flex-col justify-center px-8 sm:px-16 lg:px-24 py-12 relative z-10 bg-zinc-950">
        ...
        <div class="max-w-md w-full mx-auto relative">
            ...
            <div class="mb-10 text-left animate-fade-in-up">
                ...
                <h1 class="text-4xl font-extrabold text-white tracking-tight mb-2 leading-tight">Crie uma nova senha</h1>
                <p class="text-zinc-500 text-lg">Escolha uma senha segura para voltar a acessar sua conta NexShape.</p>
            </div>
            ...
            <form method="POST" action="{{ route('password.update') }}" id="resetForm" class="space-y-6 animate-fade-in-up" style="animation-delay: 0.1s" novalidate onsubmit="return validateForm(this)">
                ...
                <div class="space-y-3 group opacity-60">
                    <label for="email" class="text-[10px] font-black text-zinc-600 uppercase tracking-[0.2em] ml-2 italic">E-mail cadastrado</label>
                ...
                <div class="space-y-4 group">
                    <label for="password" class="text-[10px] font-black text-zinc-600 uppercase tracking-[0.2em] ml-2 transition-colors group-focus-within:text-emerald-500 italic">Nova senha</label>
                    <div class="flex items-center gap-4">
                ...
                <!-- Confirmar Senha -->
                <div class="space-y-4 group">
                    <label for="password_confirmation" class="text-[10px] font-black text-zinc-600 uppercase tracking-[0.2em] ml-2 transition-colors group-focus-within:text-emerald-500 italic">Confirmar nova senha</label>
                    <div class="flex items-center gap-4">
                        <div class="w-14 h-14 rounded-2xl bg-zinc-900 border border-zinc-800 flex items-center justify-center text-zinc-700 transition-all group-focus-within:text-emerald-500 group-focus-within:border-emerald-500/30 group-focus-within:shadow-[0_0_15px_rgba(16,185,129,0.1)] shadow-inner">
        ...
        <div class="absolute inset-0 z-20 flex flex-col justify-end p-20">
            <div class="max-w-md space-y-8 animate-fade-in-right">
                <div class="inline-flex items-center gap-3 px-4 py-2 bg-emerald-500/10 border border-emerald-500/20 rounded-full backdrop-blur-md">
                    ...
                    <span class="text-[10px] font-black text-emerald-500 uppercase tracking-widest">Acesso seguro</span>
                </div>
                
                <h2 class="text-5xl font-black text-white tracking-tighter uppercase italic leading-[0.9]">Proteja sua <br><span class="text-emerald-500">Conta.</span></h2>
                ...
                <div class="space-y-4">
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h4 class="text-xs font-black text-white uppercase tracking-widest mb-1">Senha atualizada com segurança</h4>
                            <p class="text-xs text-zinc-500 font-medium italic">Depois da redefinição, você poderá entrar normalmente no NexShape.</p>
                        </div>
                    </div>
                </div>
            </div>
