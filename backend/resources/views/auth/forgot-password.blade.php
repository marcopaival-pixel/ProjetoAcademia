    ...
    <div class="w-full lg:w-1/2 flex flex-col justify-center px-8 sm:px-16 lg:px-24 py-12 relative z-10 bg-zinc-950">
        ...
        <div class="max-w-md w-full mx-auto relative">
            ...
            <div class="mb-10 text-left animate-fade-in-up">
                ...
                <h1 class="text-4xl font-extrabold text-white tracking-tight mb-2 leading-tight">Esqueceu sua senha?</h1>
                <p class="text-zinc-500 text-lg">Informe o e-mail cadastrado e enviaremos um link para você criar uma nova senha.</p>
            </div>
            ...
            <form method="POST" action="{{ route('password.email') }}" id="resetForm" class="space-y-8 animate-fade-in-up" style="animation-delay: 0.1s" novalidate onsubmit="return validateForm(this)">
                ...
                <div class="space-y-3 group">
                    <label for="email" class="text-[10px] font-black text-zinc-600 uppercase tracking-[0.2em] ml-2 transition-colors group-focus-within:text-emerald-500 italic">E-mail cadastrado</label>
