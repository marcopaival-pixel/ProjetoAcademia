    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        @empty
            <div class="col-span-1 md:col-span-2 lg:col-span-3">
                <div class="flex flex-col items-center justify-center py-16 px-4 bg-zinc-900/20 border border-white/5 border-dashed rounded-[3rem] text-center">
                    <div class="w-20 h-20 bg-zinc-900 rounded-full flex items-center justify-center mb-6 border border-white/10 shadow-2xl">
                        <i class="fas fa-dumbbell text-3xl text-blue-400"></i>
                    </div>
                    <h4 class="text-2xl font-black text-white mb-2">Seu primeiro treino comeca aqui</h4>
                    <p class="text-zinc-500 font-medium max-w-md mb-8 text-sm">Ainda nao encontramos nenhuma planilha de treino. Escolha como deseja comecar.</p>

                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 w-full max-w-5xl">
                        <a href="{{ route('progression.plans.target-selection') }}" class="group p-6 bg-zinc-950/70 border border-blue-500/30 rounded-3xl text-left hover:border-blue-400 hover:bg-blue-500/10 transition-all shadow-xl">
                            <div class="w-12 h-12 rounded-2xl bg-blue-500/15 text-blue-400 flex items-center justify-center mb-5 border border-blue-500/20">
                                <i class="fas fa-plus"></i>
                            </div>
                            <h5 class="text-white font-black text-sm uppercase tracking-widest group-hover:text-blue-300">Criar plano manualmente</h5>
                            <p class="text-zinc-500 text-xs font-medium leading-relaxed mt-3">Monte sua ficha escolhendo areas, exercicios, series e dias da semana.</p>
                        </a>

                        <a href="{{ route('progression.plans.import-photo') }}" class="group p-6 bg-zinc-950/70 border border-emerald-500/30 rounded-3xl text-left hover:border-emerald-400 hover:bg-emerald-500/10 transition-all shadow-xl">
                            <div class="w-12 h-12 rounded-2xl bg-emerald-500/15 text-emerald-400 flex items-center justify-center mb-5 border border-emerald-500/20">
                                <i class="fas fa-camera"></i>
                            </div>
                            <h5 class="text-white font-black text-sm uppercase tracking-widest group-hover:text-emerald-300">Importar ficha de treino</h5>
                            <p class="text-zinc-500 text-xs font-medium leading-relaxed mt-3">Envie uma foto da sua ficha atual para o NexShape organizar tudo para voce.</p>
                        </a>

                        <div class="p-6 bg-zinc-950/40 border border-purple-500/20 rounded-3xl text-left opacity-75 shadow-xl">
                            <div class="w-12 h-12 rounded-2xl bg-purple-500/15 text-purple-300 flex items-center justify-center mb-5 border border-purple-500/20">
                                <i class="fas fa-wand-magic-sparkles"></i>
                            </div>
                            <div class="flex items-center justify-between gap-3">
                                <h5 class="text-white font-black text-sm uppercase tracking-widest">Gerar plano com IA</h5>
                                <span class="px-2 py-1 rounded-full bg-purple-500/10 text-purple-300 border border-purple-500/20 text-[8px] font-black uppercase tracking-widest">Em breve</span>
                            </div>
                            <p class="text-zinc-500 text-xs font-medium leading-relaxed mt-3">Receba uma sugestao personalizada com base no seu objetivo e historico.</p>
                        </div>
                    </div>
                </div>
            </div>
