...
Route::post('/community/react/{type}/{id}', [App\Http\Controllers\CommunityController::class, 'react'])->name('community.react');
Route::get('/community/reaction-counts', [App\Http\Controllers\CommunityController::class, 'reactionCounts'])->name('community.reaction-counts');
Route::post('/community/post/{post}/comment', [App\Http\Controllers\CommunityController::class, 'comment'])->name('community.comment');
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::prefix('community')->name('community.')->group(function () {
        ...
        Route::delete('/post/{post}', [App\Http\Controllers\CommunityController::class, 'destroy'])->name('destroy');
    });
