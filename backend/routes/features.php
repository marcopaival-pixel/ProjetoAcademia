...
use App\Http\Controllers\NutritionAIController;
...
Route::prefix('nutrition/api')->name('nutrition.api.')->group(function () {
    ...
    Route::post('/natural-language', [NutritionAIController::class, 'naturalLanguage'])->name('natural-language');
    Route::post('/process-photo', [NutritionAIController::class, 'processPhoto'])->name('process-photo');
});
...
Route::prefix('progression')->name('progression.')->group(function () {
    ...
    Route::prefix('plans')->name('plans.')->group(function () {
        ...
        Route::post('/validate-photo', [\App\Http\Controllers\WorkoutPhotoImportController::class, 'validatePhoto'])->name('validate-photo');
        Route::post('/validate-photos', [\App\Http\Controllers\WorkoutPhotoImportController::class, 'validatePhotos'])->name('validate-photos');
        Route::post('/process-photo', [\App\Http\Controllers\WorkoutPhotoImportController::class, 'process'])->name('process-photo');
        Route::post('/process-photos', [\App\Http\Controllers\WorkoutPhotoImportController::class, 'processPhotos'])->name('process-photos');
        Route::post('/orchestrated/initialize', [\App\Http\Controllers\WorkoutPhotoImportController::class, 'orchInitialize'])->name('orch-initialize');
        Route::post('/orchestrated/validate/{uuid}', [\App\Http\Controllers\WorkoutPhotoImportController::class, 'orchValidate'])->name('orch-validate');
        Route::post('/orchestrated/substitute/{uuid}', [\App\Http\Controllers\WorkoutPhotoImportController::class, 'orchSubstitute'])->name('orch-substitute');
        Route::post('/orchestrated/process/{uuid}', [\App\Http\Controllers\WorkoutPhotoImportController::class, 'orchProcess'])->name('orch-process');
        Route::get('/orchestrated/status/{uuid}', [\App\Http\Controllers\WorkoutPhotoImportController::class, 'orchStatus'])->name('orch-status');
        Route::post('/save-import', [\App\Http\Controllers\WorkoutPhotoImportController::class, 'save'])->name('save-import');
        Route::post('/clear-history', [\App\Http\Controllers\WorkoutPhotoImportController::class, 'clearHistory'])->name('clear-history');
        Route::get('/target-selection', [TrainingPlanController::class, 'targetSelection'])->name('target-selection');
        Route::post('/target-selection/validate-photo', [TrainingPlanController::class, 'validateTargetPhoto'])->name('validate-target-photo');
...
Route::prefix('evolution')->name('evolution.')->group(function () {
    ...
    Route::post('/validate-photo', [\App\Http\Controllers\EvolutionController::class, 'validatePhoto'])->name('validate-photo');
    ...
    Route::middleware('premium')->group(function() {
        ...
        Route::post('/analyze-session', [\App\Http\Controllers\EvolutionController::class, 'analyzeSession'])->name('analyze-session');
