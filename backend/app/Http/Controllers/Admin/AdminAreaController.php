...
class AdminAreaController extends Controller
{
    ...
    public function storeUser(Request $request)
    {
        ...
        $data = $request->validate($rules, $this->passwordValidationMessages());
    ...
    public function changeAdminPassword(Request $request)
    {
        ...
        ], $this->passwordValidationMessages('new_password'));
    ...
    {
        return [
            "{$field}.regex" => 'A senha deve conter pelo menos uma letra maiúscula, um número e um caractere especial.',
        ];
    }
}
