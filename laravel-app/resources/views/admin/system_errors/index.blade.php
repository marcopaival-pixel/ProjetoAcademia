...
<div class="space-y-8 animate-fade-in">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
            <h2 class="text-3xl font-black text-white tracking-tight italic">Relatórios de <span class="text-red-500">Exceção</span></h2>
    ...
    <div class="bg-zinc-900/80 border border-white/10 rounded-[3rem] w-full max-w-6xl shadow-3xl flex flex-col max-h-full">
        ...
        <div class="p-10 border-b border-white/5 flex items-center justify-between">
            <div>
                ...
                <h2 class="text-2xl font-black text-white tracking-tight mt-1">Diagnóstico do Incidente</h2>
            </div>
