...
<div class="p-6 max-w-5xl mx-auto">
    <div class="flex items-center justify-between mb-10">
        <div>
            ...
            <p class="text-gray-400 mt-2 uppercase text-xs font-black tracking-widest">Defina o nome e as permissões de acesso</p>
        </div>
    ...
    <form action="{{ route('admin.roles.store') }}" method="POST">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="3"
                            class="w-full bg-black/40 border border-white/10 rounded-2xl px-6 py-4 text-white font-medium focus:outline-none focus:ring-2 focus:ring-blue-500/40 transition-all placeholder:text-gray-700 resize-none">{{ old('description') }}</textarea>
                    </div>
                </div>
            </div>
                    ...
                    <div>
                        ...
                        <div class="space-y-3">
                            ...
                            <label class="flex items-center gap-4 cursor-pointer group p-3 rounded-2xl border border-white/[0.03] hover:bg-white/[0.03] hover:border-white/10 transition-all">
                                <input type="checkbox" name="permissions[]" value="{{ $permission->id }}" class="hidden peer">
        ...
        <div class="flex justify-end pt-6 border-t border-white/5 gap-6">
            <button type="reset" class="px-8 py-4 text-gray-400 hover:text-white transition-all uppercase text-xs font-black tracking-widest shadow-xl">Limpar</button>
