...
class MediaController extends Controller
{
    ...
    private function serveEvolution($user, int $id): StreamedResponse
    {
    ...
    private function serveGallery($user, int $id): StreamedResponse
    {
    ...
    private function servePatientDocument($user, int $id): StreamedResponse
    {
