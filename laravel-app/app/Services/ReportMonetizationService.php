...
class ReportMonetizationService
{
    ...
    public function getAvailableReports(User $user): array
    {
        ...
        return [
            ...
            'premium' => [
                ['id' => 'complete_analytics', 'label' => 'Relatórios de Performance Completos', 'icon' => 'fas fa-chart-line', 'premium' => true],
                ['id' => 'detailed_finance', 'label' => 'Relatórios Financeiros Detalhados', 'icon' => 'fas fa-file-invoice-dollar', 'premium' => true],
                ['id' => 'custom_period', 'label' => 'Filtros por Período Personalizado', 'icon' => 'fas fa-calendar-alt', 'premium' => true],
                ['id' => 'comparative', 'label' => 'Relatórios Comparativos (Evolução)', 'icon' => 'fas fa-balance-scale', 'premium' => true],
                ['id' => 'professional_performance', 'label' => 'Relatórios por Profissional', 'icon' => 'fas fa-user-tie', 'premium' => true],
                ['id' => 'management_reports', 'label' => 'Relatórios Gerenciais & Churn', 'icon' => 'fas fa-tasks', 'premium' => true],
                ['id' => 'kpi_dashboard', 'label' => 'Dashboard com Indicadores (KPIs)', 'icon' => 'fas fa-tachometer-alt', 'premium' => true],
